...
import { FloatingIpCreateForm } from '@/features/floating-ip';
import { FloatingIPAssignDialog } from '@/features/floating-ip';
  ...
  return (
    <div className="space-y-12">
      <div className="space-y-6">
        <div>
          <h2 className="text-xl font-semibold">Assign</h2>
          <p className="text-muted-foreground">
            You can assign a Floating IP to any virtances.
          </p>
        </div>
        <FloatingIpCreateForm virtances={virtances} onCreate={onCreate} />
      </div>
