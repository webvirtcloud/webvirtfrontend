...
const inputVariants = cva(
  'w-full text-sm px-3 transition-all shadow-sm disabled:shadow-none border rounded-md bg-muted/50 focus:bg-background placeholder:text-muted-foreground focus:outline-none focus:ring-offset-0 focus:ring-2 focus:ring-ring/30 focus:border-ring h-10',
  {
    variants: {
      error: {
